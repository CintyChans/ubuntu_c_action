...
class MsgPerson::_Internal {
 public:
};

MsgPerson::MsgPerson(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
const char* MsgPerson::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData MsgPerson::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    MsgPerson::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*MsgPerson::GetClassData() const { return &_class_data_; }
...
bool MsgPerson::IsInitialized() const {
  return true;
}
